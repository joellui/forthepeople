...
export const metadata: Metadata = {
  ...
  description:
    "ForThePeople.in is an independent citizen platform. Data is sourced from government portals and may have a delay.",
      ...
      >
        ...
        <section>
          ...
          <p style={{ margin: 0 }}>
            ...
            While we strive for accuracy, data may have a delay of up to 24 hours for live
            modules. Historical data is presented as published by the originating government
            body and has not been independently verified by us.
          </p>
          <p style={{ marginTop: 10 }}>
            <strong>Do not use this platform for critical real-time decisions</strong>{" "}
            (e.g., emergency response, medical decisions, legal filings). Always refer to the
            original government portal for official data.
          </p>
        </section>
        ...
        <section>
          ...
          <p style={{ margin: 0 }}>
            The RTI templates, scheme information, and citizen rights content on this platform
            are provided for informational purposes only. They do not constitute legal advice.
        ...
        <section>
          ...
          <p style={{ margin: 0 }}>
            This platform links to external government websites. We are not responsible for
            the content, availability, or accuracy of those websites. Links to external sites
        ...
        <section>
          ...
          <p style={{ margin: 0 }}>
            ForThePeople.in and its contributors shall not be liable for any loss or damage
            arising from the use of, or reliance on, information presented on this platform.
